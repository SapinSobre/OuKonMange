...
namespace OuKonMange3.Models
{
    public class AuMoinsUnDesDeuxAttribute : ValidationAttribute, IClientValidatable
    {
        ...
        public AuMoinsUnDesDeuxAttribute() : base("Kantmeim Vous devez saisir au moins un moyen de contacter le restaurant")
        {
        }
        ...
        public IEnumerable<ModelClientValidationRule> GetClientValidationRules(ModelMetadata metadata, ControllerContext controller)
        {
